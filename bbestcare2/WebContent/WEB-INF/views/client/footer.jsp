		...
		<div class="sub-footer">
			<div class="container">
				<!-- <div class="botttom-nav-allah">
					<ul>
						<li><a href="client/home.htm" class="scroll">Trang chủ</a></li>
						<li><a href="client/order.htm" class="scroll">Đặt lịch</a></li>
						<li><a href="#services" class="scroll">Dịch vụ</a></li>
						<li><a href="#team" class="scroll">Đội ngũ</a></li>
						<li><a href="client/recruitment.htm" class="scroll">Tuyển dụng</a></li>
				</div> -->
				<div class="mkls_footer_grid">
					<div class="mkls_footer_grid_left">
						<h4>
							<i class="fa fa-map-marker" aria-hidden="true"></i>Vị trí:
						</h4>
						<p>
							Cao đẳng thực hành FPT PolyTechnic<br> Hà Nội
						</p>
					</div>
					<div class="mkls_footer_grid_left">
						<h4>
		...
		<div class="footer-copy-right">
			<div class="container">
				<div class="allah-copy">
					<p>
						© 2020 BBestCare. Hệ thống chăm sóc trẻ em uy tín, chất lượng !
					</p>
				</div>
