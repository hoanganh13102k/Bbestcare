		...
		<div class="form-36-mian section-gap">
			<div class="wrapper">
				...
				<a href="home.htm"><span><img src="../images/logo-01.png" style="width: 100px; height: 100px;bottom: 0.5px;margin-left: 110px;"></span></a>
					<h3 style="text-align: center; font-weight: bold; font-size: xx-large;">Đăng nhập</h3>
					
					<form action="loginCustomer.htm" method="post">
						<div class="form-input">
							<span class="fa fa-envelope-o" aria-hidden="true"></span> <input type="text" id="phone" name="phone"
                      ...
                      <div>
						...
						<div class="new-signup">
							<a href="../client/loginAdmin.htm" class="signuplink">Đăng nhập với tài khoản nhân viên</a>
						</div>
						<div class="new-signup">
