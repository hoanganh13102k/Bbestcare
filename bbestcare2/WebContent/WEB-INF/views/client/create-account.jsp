		...
		<div class="form-36-mian section-gap">
			<div class="wrapper">
				...
				<a href="home.htm"><span><img src="../images/logo-01.png" style="width: 100px; height: 100px;bottom: 0.5px;margin-left: 110px;"></span></a>
					<h3 style="text-align: center; font-weight: bold; font-size: xx-large;">Đăng ký</h3>
					<br>
					<form:form class="user" action="create-account.htm" modelAttribute="customer">              
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <form:input type="text" path="phone" class="form-control form-control-user" id="" placeholder="Số điện thoại" required="required"/>
                  </div>
                  <div class="col-sm-6">
                    <form:input type="text" path="fullname" class="form-control form-control-user" id="" placeholder="Họ tên" required="required"/>
                  </div>
                </div>
                <div class="form-group">
                  <form:input type="email" path="email" class="form-control form-control-user" id="" placeholder="Email" required="required"/>
                </div>
                <div class="form-group">
                  <form:input type="text" path="address" class="form-control form-control-user" id="" placeholder="Địa chỉ" required="required"/>
                </div>
                <div class="form-group">
                  <form:input type="text" path="birthdaybaby" class="form-control form-control-user" id="" placeholder="Ngày sinh bé" required="required"/>
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <form:input type="password" path="password" class="form-control form-control-user" id="password" placeholder="Mật khẩu" required="required"/>
                  </div>
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" id="confirm_password" placeholder="Nhập lại mật khẩu" required="required">
                  </div>
                </div>
              ...
              <div class="text-center">
                <a class="small" href="loginCustomer.htm">Bạn đã có tài khoản? Đăng nhập!</a>
              </div>
				</div>
