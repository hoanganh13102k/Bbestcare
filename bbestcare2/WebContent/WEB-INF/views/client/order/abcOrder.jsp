...
<form method="post" action="client/order/orderLichKhachHang.htm" >
<br>
<br>
<h1 style="font-family: sans-serif; font-weight: bolder; color: #17449e;text-align: center;;">ĐẶT LỊCH</h1>
<br>
<br>
...
<label>Phone</label>
<input class="form-control" type="text" name="phone" value="${user.phone}" readonly="true"><br>

<div class="form-group">
<select name="city" id="countySel" >
  <option value="" selected="selected" disabled="disabled" class="form-control">Thành phố</option>
 </select>
...
<label>Giá</label>
<input class="form-control" type="text" name="price" id="box1" value="120000" readonly="readonly"><br>
 <!-- <label>Nhân viên</label>
<input class="form-control" type="text" name="staff" ><br> -->
...
<input class="form-control" type="text" name="note" value="Đã gửi"><br>
</div>
