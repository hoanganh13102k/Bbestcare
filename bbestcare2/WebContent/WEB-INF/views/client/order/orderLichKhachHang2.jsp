...
String user = "sa";
String pass = "quan";
String url = "jdbc:sqlserver://localhost:1433;databaseName=NNNNNN";
Connection con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=NNNNNN", "sa", "quan");
Statement st=con.createStatement();

st.executeUpdate("insert into Orders(Date,Phone) values(GETDATE(),'"+phone+"'");

for(int i=0;i<dated.length;i++){
	st.executeUpdate("insert into OrderDetail(ID_Orders,Email,Phone,City,District,Ward,Street,Dated,Slot,Price,Staff,Note) values((select Max(ID) from Orders),'"+email+"','"+phone+"',N'"+city+"',N'"+district+"',N'"+ward+"',N'"+street+"','"+dated[i]+"','"+slot[i]+"',N'"+price+"',N'"+staff+"',N'"+note+"')");
}
try{
...
<g>
 ...
 <i  style="font-size: 300px;color: #17449e;" class="fas fa-check-circle"></i>
			...
			<a href="client/home.htm">Quay lại Trang chủ</a>
		</div>
	</div>
	<script>
