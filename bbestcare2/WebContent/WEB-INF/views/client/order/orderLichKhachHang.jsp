...
for(int i=0;i<dated.length;i++){
	st.executeUpdate("insert into LichKhachHang(Email,Phone,City,District,Ward,Street,Dated,Slot,Price,Staff,Note) values('"+email+"','"+phone+"',N'"+city+"',N'"+district+"',N'"+ward+"',N'"+street+"','"+dated[i]+"','"+slot[i]+"',N'"+price+"',N'"+staff+"',N'"+note+"')");
}
try{
