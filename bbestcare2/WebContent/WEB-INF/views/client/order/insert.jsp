...
<br>
<br>
	<h1 style="color: #00bcd5; font-weight: bold;text-transform: capitalize;font-family: 'Dosis', sans-serif;text-align: center;" class="header-w3ls">Đặt lịch</h1>
	<br>
	<div>
	<div style="width: 50%;margin: 0 auto;">
	<form:form action="client/order/insert.htm" modelAttribute="lichkhachhang">
	<br>
	<br>
	<br>
	<br>
	<br>
		...
		<br>
		<select name="city" id="countySel" class="form-group">
			<option value="" selected="selected" disabled="disabled">Thành
				phố</option>
		</select>
		<select name="district" id="stateSel" class="form-group">
			<option value="" selected="selected" disabled="disabled">Quận,Huyện</option>
		</select>
		<select name="ward" id="districtSel" class="form-group">
			<option value="" selected="selected" disabled="disabled">Phường</option>
		</select>
		<div class="form-group">
			<form:label path="street">Đường</form:label>
			<form:input class="form-control" path="street" required="required" />
		</div>
		<div class="form-group">
			<form:label path="dated">Ngày</form:label>
			<form:input class="form-control" path="dated" type="date" min="today"
				required="required" />
		</div>
		<form:label path="slot">Ca</form:label>
		<select name="slot" id="slot" class="form-control">
			<option value="" selected="selected" disabled="disabled">Slot</option>
			<option value="1">1(8-10.AM)</option>
			<option value="2">2(10-12.AM)</option>
			<option value="3">3(1-3.PM)</option>
			<option value="4">4(3-5.PM)</option>
		</select>
		<br>
		<div class="form-group">
			<form:label path="note">Ghi chú</form:label>
			<form:input class="form-control" path="note" required="required" />
		</div>
...
<script>
var stateObject = {
// "Thanh Xuân": { "Khương Đình": ["new Delhi", "North Delhi"],
