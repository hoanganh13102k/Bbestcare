...
<body>
    ...
    <ellipse transform="scale(-1) rotate(45 454 -421.3)" cx="174.5"
          ...
          <path
				...
				<input name="note" style="border: 1px solid black;text-align: center;" placeholder="Nội dung đánh giá"> <br>
	...
	<br>
	<c:forEach var="n" items="${listFeedback}">
    ...
    <div class="row">
      <div class="col" >
      <h2 style="text-align: center;color: #17449e;">${n.nameCustomer}</h2>
      </div>
      <div class="col1">
        	<p class="o-hide">${n.id}</p>
			<p  style="font-size: 25px;font-weight: bold;">${n.star}</p>
            <p style="font-size: 10px;">${n.date}</p>
            <p style="font-size: 18px;">${n.note}</p>
