		...
		<div class="form-36-mian section-gap">
			<div class="wrapper">
				...
				<a href="home.htm"><span><img src="../images/logo-01.png" style="width: 100px; height: 100px;bottom: 0.5px;margin-left: 110px;"></span></a>
                    ...
                    <h1 class="h4 text-gray-900 mb-2" style="text-align: center; font-weight: bold; font-size: xx-large;">Quên mật khẩu?</h1>
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="../client/create-account.htm">Đăng ký tài khoản</a>
                  </div>
                  <div class="text-center">
                    <a class="small" href="../client/loginCustomer.htm">Bạn đã có tài khoản? Đăng nhập!</a>
                  </div>
