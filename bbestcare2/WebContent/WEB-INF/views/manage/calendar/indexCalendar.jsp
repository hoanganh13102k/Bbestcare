...
<sql:query dataSource="${snapshot}" var="result1">
         select * from LichKhachHang  where Staff = '${staff.phone}' and Note = N'Đã xếp';
      </sql:query>

<sql:query dataSource="${snapshot}" var="result2">
         select * from LichKhachHang  where Phone = '${staff.phone}' and Note = N'Hoàn thành' ;
      </sql:query>
  		...
  		<table border="1" width="100%" class="table table-bordered" style="border: 1px solid #dddfeb;border-radius:3px;" id="example">
			...
			<c:forEach var="row" items="${result.rows}">
				<tr>
					...
					<td scope="row"><a href="client/delete1/${row.id}.htm" style="color: white; background-color: red; border: 1px solid red;border-radius: 50px; ">Hủy</a>
					<i ></i>
					</td>
				</tr>
			</c:forEach>
