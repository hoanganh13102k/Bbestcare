...
<%-- <script  type="text/javascript">
    function randomString() {
      ...
      document.getElementById("abc").value = 'bbest' + randomstring;
    }
    function randomString1() {
        ...
        document.getElementById("abc1").value = randomstring;
      }
    function name1() {
              ...
              <div class="table-responsive">
					<form:form action="manage/recruitment/update.htm" modelAttribute="staff">
						<div class="form-group">
							<form:label path="phone" >SDT</form:label> 
						...
						<br>
						<div style="text-align: center;"><button type="submit" class="btn btn-primary">Cập nhật</button></div>
					</form:form>
